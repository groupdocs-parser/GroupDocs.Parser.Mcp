...
Only the **latest released version** of `GroupDocs.Parser.Mcp` (GHCR)
...
- The Docker image is self-contained; the server makes no network calls at runtime.
...
- Use GitHub's [private vulnerability reporting](https://github.com/groupdocs-parser/GroupDocs.Parser.Mcp/security/advisories/new)
...
- Vulnerabilities in the underlying `GroupDocs.Parser` engine (a closed-source NuGet
